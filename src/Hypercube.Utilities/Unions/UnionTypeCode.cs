...
/// <summary>
/// Copy of <see cref="TypeCode" /> with smaller size.
/// </summary>
public enum UnionTypeCode : byte
{
    /// <summary>
    /// A null reference.
    /// </summary>
    ...
    /// <summary>
    /// A general type representing any reference or value type not explicitly represented by another <see cref="UnionTypeCode" />.
    /// </summary>
    Object = 1,
    ...
    /// The set of possible values for the <see cref="F:System.TypeCode.Char" /> type corresponds to the Unicode character set.
    /// </summary>
    Char = 4,
